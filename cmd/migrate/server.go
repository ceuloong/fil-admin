...
import (
	...
	_ "fil-admin/cmd/migrate/migration/version"
	_ "fil-admin/cmd/migrate/migration/version-local"
...
func init() {
	...
	StartCmd.PersistentFlags().BoolVarP(&goAdmin, "goAdmin", "a", false, "generate fil-admin migration file")
